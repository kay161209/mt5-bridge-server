...
### ポジション管理
- `/v5/private/position/close` - ポジションを閉じる
- `/v5/private/position/close_partial` - ポジションを部分的に閉じる
- `/v5/private/position/modify` - ポジションのSL/TPを変更する

### 注文管理
- `/v5/private/order/cancel` - 注文をキャンセルする
- `/v5/private/order/modify` - 注文を変更する
